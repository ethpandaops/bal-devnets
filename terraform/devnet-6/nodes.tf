...
variable "nodes" {
  ...
  default = [
    ...
    { name = "lighthouse-ethrex", count = 1, cloud = "hetzner", validator_start = 800, validator_end = 1000 },
    { name = "lighthouse-erigon", count = 1, cloud = "hetzner", validator_start = 1000, validator_end = 1200 },
    { name = "lodestar-geth", count = 1, cloud = "hetzner", validator_start = 1200, validator_end = 1400 },
    { name = "lodestar-besu", count = 1, cloud = "hetzner", validator_start = 1400, validator_end = 1600 },
    { name = "lodestar-nethermind", count = 1, cloud = "hetzner", validator_start = 1600, validator_end = 1800 },
    { name = "lodestar-reth", count = 1, cloud = "hetzner", validator_start = 1800, validator_end = 2000 },
    { name = "lodestar-ethrex", count = 1, cloud = "hetzner", validator_start = 2000, validator_end = 2200 },
