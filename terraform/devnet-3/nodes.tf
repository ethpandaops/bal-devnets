...
variable "nodes" {
  ...
  default = [
    ...
    { name = "lighthouse-ethrex-super", count = 1, cloud = "hetzner", validator_start = 1000, validator_end = 1200 },
    { name = "lighthouse-erigon-super", count = 1, cloud = "hetzner", validator_start = 1200, validator_end = 1400 },
    { name = "lodestar-geth-super", count = 1, cloud = "hetzner", validator_start = 1400, validator_end = 1600 },
    { name = "lodestar-besu-super", count = 1, cloud = "hetzner", validator_start = 1600, validator_end = 1800 },
    { name = "lodestar-nethermind-super", count = 1, cloud = "hetzner", validator_start = 1800, validator_end = 2000 },
    { name = "lodestar-reth-super", count = 1, cloud = "hetzner", validator_start = 2000, validator_end = 2200 },
    { name = "lodestar-nimbusel-super", count = 1, cloud = "hetzner", validator_start = 2200, validator_end = 2400 },
    { name = "lodestar-ethrex-super", count = 1, cloud = "hetzner", validator_start = 2400, validator_end = 2600 },
